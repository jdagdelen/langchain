...
class FAISS(VectorStore):
    ...
    def load(
        ...
        with open(os.path.join(saved_directory, "docstore.pickle"), "rb") as f:
            docstore = pickle.load(f)
        with open(os.path.join(saved_directory, "index_to_docstore_id.pickle"), "rb") as f:
            index_to_docstore_id = pickle.load(f)
        with open(os.path.join(saved_directory, "embedding_function.pickle"), "rb") as f:
    ...
    def save( self, save_directory: Path,):
        ...
        with open(os.path.join(save_directory, "docstore.pickle"), "wb") as f:
            pickle.dump(self.docstore, f)
        with open(os.path.join(save_directory, "index_to_docstore_id.pickle"), "wb") as f:
